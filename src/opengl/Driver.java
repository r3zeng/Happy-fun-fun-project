...
/******* Preparation ***************************************/
		...
		entity.Scale(scale);
		Lighting[] lights = new Lighting[8]; 
		
		lights[0] = new Lighting(new Vector3f(1000, 1000, 1000), new Vector3f(1f, 1f, 1f));
		lights[1] = new Lighting(new Vector3f(1000, 1000, -10000), new Vector3f(1f, 1f, 1f));
		lights[2] = new Lighting(new Vector3f(1000, -1000, 1000), new Vector3f(1f, 1f, 1f));
		lights[3] = new Lighting(new Vector3f(1000, -1000, -1000), new Vector3f(1f, 1f, 1f));
		lights[4] = new Lighting(new Vector3f(-1000, 1000, 1000), new Vector3f(1f, 1f, 1f));
		lights[5] = new Lighting(new Vector3f(-1000, 1000, -1000), new Vector3f(1f, 1f, 1f));
		lights[6] = new Lighting(new Vector3f(-1000, -1000, 1000), new Vector3f(1f, 1f, 1f));
		lights[7] = new Lighting(new Vector3f(-1000, -1000, -1000), new Vector3f(1f, 1f, 1f));
