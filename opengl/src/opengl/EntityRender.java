...
public class EntityRender {
	...
	public void render(Map<TexturedModel,List<Entity>> entities){
		...
		for(TexturedModel Tm:entities.keySet()){
			...
			for(Entity entity:batch){
				...
				/* renders the entity */
				GL11.glDrawElements(GL11.GL_TRIANGLES, entity.getTexturedModel().getModel().getVertexCount(),
	...
	private void prepareTexturedModel(TexturedModel Tm){
		...
		/* loads shine and reflectivity */
		shader.loadShineAndReflectivity(Tm.getTexture());
